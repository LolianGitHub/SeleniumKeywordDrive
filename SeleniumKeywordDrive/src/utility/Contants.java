...
//	定义访问地址
	public static  String url="https://softwareofexcellence.com/nz";
//	定义基本路径
	public static String baseUrl="C:\\Users\\zian1\\Git\\SeleniumKeywordDrive";
//	定义驱动路径
...
//	登陆的用户明和密码
	public static String userName="first name";
